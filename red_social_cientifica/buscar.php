...
<div class="resultados-busqueda">
	<?php if(!empty($resultados)): ?>
		...
		<?php endforeach; ?>
	<?php else: ?>
		<h1 class="no-resultados">No se encontraron usuarios pero busque por contenidos</h1>
		
	<?php endif; ?>
	<form action="index.php" method="get" id="buscar">
 			<input type="text" name="buscar" placeholder="Buscar por titulo de post">
